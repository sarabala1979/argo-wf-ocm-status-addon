...
const (
	LabelKeyHubWorkflowUID = "workflows.argoproj.io/hub-workflow-uid"
)
...
var WorkflowPredicateFunctions = predicate.Funcs{
	...
	UpdateFunc: func(e event.UpdateEvent) bool {
		...
		return containsValidOCMLabel(*newWf) && !reflect.DeepEqual(newWf.Status, oldWf.Status)
	},
	CreateFunc: func(e event.CreateEvent) bool {
		workflow := e.Object.(*argov1alpha1.Workflow)
		return containsValidOCMLabel(*workflow)
	},
...
func (c *ArgoWorkflowStatusController) SetupWithManager(mgr ctrl.Manager) error {
	c.log.Info(fmt.Sprintf("SetupWithManager... "))
...
func (c *ArgoWorkflowStatusController) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	c.log.Info("creating WorkflowStatusResult")
	hubWorkflowStatusResult := argov1alpha1.WorkflowStatusResult{}
